...
cmdline="sudo PATH=/usr/local/bin/sleuthkit-4.11.1_iped_patch/bin/:$PATH java -jar iped.jar -o /home/kali/Desktop/IPED-CASO/ -profile fastmode -l /usr/local/bin/iped/palavras-chave.txt"
